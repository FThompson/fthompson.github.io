...
function addProject(project) {
    ...
    if (project.report) {
        let href = '/static/projects/reports/' + project.report
        $('<a>').attr('href', href).attr('title', 'View report').attr('target', '_blank')
                .text('View report').appendTo(card)
    }
    if (project.content) {
        ...
        $('<a>').attr('href', hash).attr('title', 'Read more').text('Read more').appendTo(card)
    }
